//
//  WTHWhiteMJRefreshHeader.m
//  wentoubao
//
//  Created by iOS－Dev on 2017/7/12.
//  Copyright © 2017年 joinbank. All rights reserved.
//

#import "WTHWhiteMJRefreshHeader.h"

@implementation WTHWhiteMJRefreshHeader
...
- (void)prepare{
    ...
    UIImage *image = [UIImage imageNamed:@"loading_complete"];
